...
void main() {
  ...
  col = max(col, vec3(0.82)); // floor: light-mode canvas never goes dark
...
export function Velaris({
  bg = "#042a38",
  colors = ["#015f74", "#46b2be", "#0b4d5c", "#1a7a8a"],
  speed = 1.4,
  grain = 0.18,
  className,
  style,
  ...
  useEffect(() => {
    ...
    const render = (t: number) => {
      ...
      gl.uniform3fv(locs.colors, new Float32Array(colors.slice(0, 4).flatMap(hexToRgb)));
